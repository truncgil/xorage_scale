                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group">
                        <select name="order" id="" class="form-control">
                            ...
                            <option value="">{{e2("Sıralama Yok")}}</option>
                            <?php foreach($durum AS $d)  { 
                            ?>
                            <option value="{{$d}}" <?php if(getesit("order",$d)) echo "selected"; ?>>{{e2($d)}}</option> 
                            <?php } ?>
                        ...
                        <select name="by" id="" class="form-control">
                            ...
                            <?php foreach($durum AS $d)  { 
                            ?>
                            <option value="{{$d}}" <?php if(getesit("by",$d)) echo "selected"; ?>>{{e2($d)}}</option> 
                            <?php } ?>
