   ...
   // $("#sonuc").load("?ajax=print-stok&noprint&id=20211117123785");
    ...
    const html5QrCode = new Html5Qrcode("reader");
                                ...
                                (decodedText, decodedResult) => {
                                    ...
                                    //alert(decodedText);
                                    $("#sonuc").load("?ajax=print-stok&noprint&id="+decodedText+"&<?php echo e(rand()); ?>",function(d){
                                        location.href="#sonuc";
                                    });
...
</div><?php /**PATH /home/pgutrunc/bta.truncgil.com/resources/views/admin/type/barkod-okuyucu.blade.php ENDPATH**/ ?>