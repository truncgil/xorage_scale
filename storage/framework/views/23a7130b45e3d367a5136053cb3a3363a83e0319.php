                            ...
                            <?php if(getisset("duzenle")) {
                                 ...
                                 <?php 
                                    foreach($j AS $alan=> $deger) {
                                        ...
                                        $("[name='<?php echo e($alan); ?>']").append(newOption).trigger('change');
                                    //.val("<?php echo e($deger); ?>").trigger("change");
                                        <?php 
                                    }
                                    ?>
                                 <?php 
...
<?php 
   ...
   console.log("ok");
        ...
        <?php echo e(_col()); ?><?php /**PATH E:\Works\xampp7\htdocs\bta\resources\views/admin/type/siparisler/yeni-siparis-formu.blade.php ENDPATH**/ ?>