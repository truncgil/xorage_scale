<?php 
			...
			<div class="btn-group">
				<?php if(!getisset("negatif-gizle"))  { 
				  ?>
 				<a href="?negatif-gizle" class="btn btn-primary"><?php echo e(e2("Negatif Stokları Gizle")); ?></a> 
				 <?php } ?>
				 <?php if(getisset("negatif-gizle"))   { 
				   
 				  ?>
 				<a href="?negatif-goster" class="btn btn-primary"><?php echo e(e2("Negatif Stokları Göster")); ?></a> 
				  <?php } ?>
			</div>
            ...
            <?php /**PATH E:\Works\xampp7\htdocs\bta\resources\views/admin/type/istatistik/urun-stoklari.blade.php ENDPATH**/ ?>