    ...
    <div class="print text-center">
        ...
        <table class="table text-center">
            <tr>
                ...
                <td style="vertical-align:middle">
                    <strong><?php echo e($musteri->title); ?></strong> <br>
                    <small><?php echo e($musteri->adres); ?></small> <br>
                    <small><?php echo e(e2("VERGİ DAİRESİ")); ?> : <?php echo e($musteri->vd); ?> <br>
                    <?php echo e(e2("VERGİ NO")); ?> : <?php echo e($musteri->vn); ?></small>
                </td>
            </tr>
        </table>
        ...
        <table class="table table-bordered">
            ...
            <?php foreach($siparis_json AS $alan => $deger) {
                ...
                <tr>
                    <th><?php echo e(e2("SEVK EDİLEN TOPLAM")); ?></th>
                    <td><?php echo e($sayim); ?></td>
                </tr>
                <tr>
                    <th><?php echo e(e2("KALAN")); ?></th>
                    <td><?php echo e($siparis->qty - $sayim); ?></td>
                </tr>
        </table>
...
<?php /**PATH /home/pgutrunc/bta.truncgil.com/resources/views/admin-ajax/print-siparis.blade.php ENDPATH**/ ?>